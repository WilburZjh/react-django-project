...
class LikeApiTests(TestCase):
    ...
    def test_likes_in_comments_api(self):
        ...
        self.assertEqual(response.status_code, 200)
        # print(response.data)
        self.assertEqual(response.data['Comment'][0]['has_liked'], False)
        self.assertEqual(response.data['Comment'][0]['likes_count'], 0)
        ...
        response = self.dongxie_client.get(COMMENT_LIST_API, {'tweet_id': tweet.id})
        self.assertEqual(response.data['Comment'][0]['has_liked'], True)
        self.assertEqual(response.data['Comment'][0]['likes_count'], 1)
    ...
    def test_likes_in_tweets_api(self):
        ...
        response = self.dongxie_client.get(url)
        # print(response.data)
        self.assertEqual(len(response.data['Tweet']['likes']), 2)
        # print(response.data)
        self.assertEqual(response.data['Tweet']['likes'][0]['user']['id'], self.linghu.id)
        self.assertEqual(response.data['Tweet']['likes'][1]['user']['id'], self.dongxie.id)
